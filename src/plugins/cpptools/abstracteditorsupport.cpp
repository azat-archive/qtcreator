...
QString AbstractEditorSupport::licenseTemplate(const QString &file, const QString &className, const QString &projectName)
{
    return Internal::CppFileSettings::licenseTemplate(file, className, projectName);
}
}
